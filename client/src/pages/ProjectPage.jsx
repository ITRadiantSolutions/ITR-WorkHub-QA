          ...
          <div className="mb-2 flex flex-wrap items-center justify-between gap-3">
            ...
            {canCreate && (
              <button
                ...
                className="flex h-10 items-center gap-2 rounded-lg bg-indigo-600 px-4 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-700 active:scale-[0.98]"
              >
          ...
          hover:file:bg-slate-300"
            ...
            <div className="flex items-center justify-end gap-2 border-t border-slate-100 pt-4">
              ...
              <button
                ...
                disabled={submitting}
                className="flex items-center gap-1.5 rounded-xl bg-indigo-600 px-4 py-2 text-[12px] font-semibold text-white transition hover:bg-indigo-700 disabled:opacity-60"
              >
                {submitting ? (
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-14 text-center shadow-sm">
          ...
          {canCreate && (
            <button
              ...
              className="inline-flex items-center gap-2 bg-indigo-600 text-white px-3 py-2.5 rounded-xl text-sm font-semibold"
            >
              <Icon.Plus />
              Create Project
            </button>
