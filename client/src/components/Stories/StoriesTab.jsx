        ...
        <div className="border-t border-slate-100 bg-slate-50 px-4 py-3">
          <div className="flex gap-2 items-center">
            ...
            <button
              ...
              className="h-9 px-3 bg-indigo-600 text-white rounded-lg text-[12px] font-semibold hover:bg-indigo-700 transition disabled:opacity-40 flex items-center gap-1.5 shrink-0"
            >
              {postingComment ? (
                <div className="w-3.5 h-3.5 border-2 border-white/30 border-r-white rounded-full animate-spin" />
              ) : (
